...
const { extractNetlifyUrl } = require('./utils');
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  // Poll for completion; GAM reports typically complete in 5–30 s
  for (let i = 0; i < 30; i++) {
...
module.exports = { runReportAndDownload, fetchImpressions, lookupNetlifyUrlsByCreativeId, fetchMetricsByCreative };
