...
/**
 * Fetches start date, status and targeted ad units for a list of line item IDs.
 * Returns { startDateByLI, statusByLI, adUnitsByLI } where:
...
async function fetchLineItemMeta(lineItemIds, networkCode, token) {
  if (!lineItemIds.length) return { startDateByLI: {}, statusByLI: {}, adUnitsByLI: {}, keyValueIdsByLI: {} };
  const startDateByLI = {};
  const statusByLI = {};
  const adUnitsByLI = {};
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  return { startDateByLI, statusByLI, adUnitsByLI, keyValueIdsByLI };
}
