...
/*
 * Auth routes — handles the Google OAuth2 flow needed to obtain a GAM refresh token.
...
router.get('/', async (req, res, next) => {
  if (!req.query.code) return res.sendFile(path.join(__dirname, '..', 'public', 'index-desktop.html'));
  const client = getOAuth2Client();
